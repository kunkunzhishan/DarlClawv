...
export function resolveSkillIndexPath(configRoot = path.resolve("config")): string {
  return path.join(configRoot, "skills", "index.yaml");
}

export async function loadSkillIndex(configRoot = path.resolve("config")): Promise<SkillIndexDocument> {
